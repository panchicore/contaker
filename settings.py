# Django settings for aguaproject project.
import os
...
MEDIA_ROOT = os.path.join(PROJECT_DIR, "templates/media").replace('\\','/')
...
SECRET_KEY = '%m1_psia_eyb)5&99)0hy(r!bnlgd@s5)6b(#0yjte&r!f%dgv'
